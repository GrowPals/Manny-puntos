      ...
      duration: 0.5
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="w-full max-w-md z-10">
          <div className="bg-card/60 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12 border border-white/10">
            {/* Header limpio y ajustado */}
            <div className="flex items-end justify-center mb-6 gap-x-2 px-2"> {/* Cambiado a justify-center y gap-x-2 para juntar más */}
              {/* Logo Manny más grande */}
              <div className="flex items-center">
                <img 
                  alt="Manny Logo" 
                  className="h-20 w-auto" 
                  src="https://i.ibb.co/LDLWZhkj/Recurso-1.png" 
                />
              </div>
              
              {/* VIP más grande con gradiente dorado */}
              <div className="text-right">
                <h1 className="text-5xl md:text-6xl font-black uppercase tracking-tight bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 bg-clip-text text-transparent leading-none">
                  VIP
                </h1>
              </div>
            </div>

            {/* Texto descriptivo simple y sutil debajo */}
            <div className="text-center mb-6">
              <p className="text-sm md:text-base text-muted-foreground/70 max-w-2xl mx-auto font-light">
                Tú eres un Very Important Partner para Manny. Aquí podrás canjear recompensas con los puntos que acumulas en cada servicio.
              </p>
            </div>
