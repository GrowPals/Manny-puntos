...
const ProductForm = ({ product, onFinished }) => {
    ...
    const handleFileChange = async (e) => {
        ...
        try {
            const imageDataUrl = await api.subirImagenProducto(file);
        ...
        <DialogContent className="bg-card border-border text-foreground">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 py-4 max-h-[80vh] overflow-y-auto pr-2">
                ...
                <div className="space-y-2">
                    ...
                    <Input name="imagen_url" value={formData.imagen_url} onChange={handleChange} placeholder="URL de la imagen o sube un archivo" className="h-12 text-base" />
...
const AdminProductos = () => {
    const { toast } = useToast();
    const { getProductosCanje, eliminarProducto } = useNotionAPI();
