...
const AdminEntregas = () => {
    ...
    const { getTodosLosCanjes, actualizarEstadoCanje } = useNotionAPI();
    ...
    const canjesFiltrados = canjes.filter(c => (activeTab === 'productos' ? c.tipo === 'producto' : c.tipo === 'servicio') && c.estado !== (c.tipo === 'producto' ? 'entregado' : 'completado'));
